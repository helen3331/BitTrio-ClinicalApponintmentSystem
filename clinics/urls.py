...
from .views import ClinicCreateView, ClinicListView,ClinicSymptomsView ,SymptomCreateView, ClinicIDFromNameView

urlpatterns = [
    path('list/', ClinicListView.as_view(), name='clinic-list'),
    path('<int:clinic_id>/symptoms/', ClinicSymptomsView.as_view(), name='symptom-list'),
